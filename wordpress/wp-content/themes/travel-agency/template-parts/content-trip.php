                    ...
                    <div class="star-holder">
                        <?php
                            ...
                            if ( !empty( $comments ) ){
                                ...
                                <span class="rating-star" itemprop="ratingValue">'. esc_html( $aggregate ) .'</span><span itemprop="reviewCount">'. absint( $i ) .'</span> '. esc_html( _nx( 'review', 'reviews', $i, 'reviews count', 'travel-agency' ) ) .'</div>';
                ...
                <?php if( travel_agency_is_wpte_tfsd_activated() ){ 
                    ...
                    if( isset( $starting_dates['departure_dates'] ) && ! empty( $starting_dates['departure_dates'] ) && isset($starting_dates['departure_dates']['sdate']) ){ ?>
                        <div class="next-trip-info">
                            <h3><?php esc_html_e( 'Next Departure', 'travel-agency' ); ?></h3>
