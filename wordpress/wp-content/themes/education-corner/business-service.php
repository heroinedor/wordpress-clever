 ...
 */
	...
	$service_count= 0; ?> 
<!-- Service start -->
<div class="container-fluid bs-margin bs-service">
	<div class="container">
		...
		<?php while ($services->have_posts()) : 
			...
			<div class="col-md-4 col-sm-6 bs-ser">
				...
				<?php } ?>
					...
					<?php the_excerpt(); ?>
					<a class="btn ser-link" href="<?php the_permalink(); ?>"><?php esc_html_e('Read More','education-corner'); ?> <i class="fa fa-long-arrow-right"></i></a>
				</div>
			</div>
